...
function isNetlify(): boolean {
  console.log('🔵 Running on Netlify', process.env.NETLIFY);
  console.log('🔵 Running on Netlify', process.env.NETLIFY_DEV);
  console.log('🔵 Running on Netlify', process.env.AWS_LAMBDA_FUNCTION_NAME);
  return !!(
    process.env.NETLIFY ||
